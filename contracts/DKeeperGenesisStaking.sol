...
import "./interfaces/IDKeeper.sol";
...
contract DKeeperGenesisStaking {
    ...
    uint256 public constant POINT_MULTIPLIER = 10e32;
    ...
    */
     ...
     * @dev Sets the contract with the DEEP genesis NFT and DEEP reward token 
     */
        ...
        external
    {
        require(
            ...
            "DKeeperGenesisStaking.setRewardsContract: Sender must be admin"
        );
        ...
        external
    {
        require(
            accessControls.hasAdminRole(msg.sender),
            "DKeeperGenesisStaking.setTokensClaimable: Sender must be admin"
        );
    ...
    /// @notice Stake Genesis DEEP NFT and earn reward tokens. 
    function stake(
        uint256 tokenId
    )
        external
    ...
    */
        ...
        external 
    {
        require(
            ...
            "DKeeperGenesisStaking._unstake: Sender must have staked tokenID"
        );
    ...
    */
        ...
        external
    {
        require(
            accessControls.hasAdminRole(msg.sender),
            "DKeeperGenesisStaking.setContributions: Sender must be admin"
        );
        ...
        payable
    {
        ...
        require(
            ...
            "DKeeperGenesisStaking.increaseContribution: genesis NFT was not contribibuted"
        );
        ...
        require(
            contribution[_tokenId] <= MAXIMUM_CONTRIBUTION_AMOUNT,
            "DKeeperGenesisStaking.increaseContribution: You cannot exceed the maximum contribution amount"
        );
        ...
        require(
            ...
            "DKeeperGenesisStaking.increaseContribution: Unable to send contribution to funds multisig"
        );
